...
Notar que los simbolos en mayusculas son terminales, mientras los que estan en minuscula son no terminales.
...
\begin{itemize}
\item $partitura$: Es el objeto raiz, almacena el tempo, la indicacion y la lista de voces. 
